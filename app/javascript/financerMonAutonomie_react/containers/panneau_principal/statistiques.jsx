    ...
    return (
      <div className="col-lg-6">
        <div className="white-box flex flex-wrap align-items-center">
          ...
          <div className="margin-top-15 col-lg-4" style={ isMobile ? {} : { height: "145px" }}>
            <p className="point point-bleu font-12 black bold no-margin-xs">Projets</p>
            <p className={`no-margin black bold${isMobile ? " float-left margin-right-15" : ""}`} style={{fontSize: "34px", lineHeight: "41px"}}>{api.activities.projects != null ? api.activities.projects : "-"}</p>
          ...
          <div className="margin-top-15 col-lg-4" style={ isMobile ? {} : { height: "145px" }}>
            <p className="point point-jaune font-12 black bold no-margin-xs">Visitors</p>
            <p className={`no-margin black bold${isMobile ? " float-left margin-right-15" : ""}`} style={{fontSize: "34px", lineHeight: "41px"}}>{api.activities.visitors != null ? api.activities.visitors : "-"}</p>
          ...
          <div className="margin-top-15 col-lg-4" style={ isMobile ? {} : { height: "145px" }}>
            <p className="point point-vert font-12 black bold no-margin-xs">Connectés</p>
            <p className={`no-margin black bold${isMobile ? " float-left margin-right-15" : ""}`} style={{fontSize: "34px", lineHeight: "41px"}}>{api.activities.connected != null  ? api.activities.connected : "-"}</p>
